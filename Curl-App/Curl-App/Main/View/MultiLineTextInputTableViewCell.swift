...
@objc protocol MultiLineTextInputTableViewCellDelegate {
...
class MultiLineTextInputTableViewCell: UITableViewCell {
    ...
    weak var multiLineTextViewCellDelegate: MultiLineTextInputTableViewCellDelegate?
    var isFirst: Bool?
...
extension MultiLineTextInputTableViewCell: UITextViewDelegate {
    func textViewDidChange(_ textView: UITextView) {
        ...
        if isFirst == true {
            self.multiLineTextViewCellDelegate?.multiLineTextInputTextViewCell(text: textView.text,
                                                                               section: self.tag)
        }
